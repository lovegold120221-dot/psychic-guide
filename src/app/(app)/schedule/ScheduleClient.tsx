        ...
        <div className="space-y-1.5">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`px-3 py-3 rounded-xl text-xs font-semibold transition active:scale-90 ${copied ? "bg-orbit-green/20 text-orbit-green border border-orbit-green/30" : "bg-orbit-card text-zinc-400 hover:text-white border border-zinc-700/30 hover:border-zinc-600"}`}
            >
              {copied ? "Copied!" : "Copy"}
            </button>
            <button
