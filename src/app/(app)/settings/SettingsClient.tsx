        ...
        <div className="max-w-3xl mx-auto p-4 sm:p-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500 mt-0.5 hidden sm:block">Customize your Orbit experience</p>
            </div>
          </div>

          {/* Tabs */}
          <div className="flex gap-1 mb-8 border-b border-white/[0.06] overflow-x-auto scrollbar-none">
            {tabs.map((t) => (
              <button
                key={t.key}
                onClick={() => setTab(t.key)}
                className={`px-4 py-2.5 text-sm font-medium transition border-b-2 -mb-px whitespace-nowrap ${
                  tab === t.key ? "text-orbit-blue border-orbit-blue" : "text-zinc-500 border-transparent hover:text-zinc-200"
                }`}
              >
                {t.label}
              </button>
